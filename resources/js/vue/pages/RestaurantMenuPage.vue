  ...
  >
    ...
    <transition name="drawer-fade">
      <div 
        ...
        class="fixed bottom-20 left-4 right-4 md:bottom-6 md:left-1/2 md:-translate-x-1/2 md:right-auto z-40 max-w-xl w-[calc(100%-2rem)] md:w-[480px] bg-white dark:bg-slate-900/80 backdrop-blur-xl border border-slate-300 dark:border-slate-700/50 p-4 rounded-2xl shadow-2xl flex items-center justify-between select-none"
      >
