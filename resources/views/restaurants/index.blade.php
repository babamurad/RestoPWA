<x-layouts.app>
    ...
    <div class="bg-gray-50 lg:bg-transparent min-h-screen lg:min-h-0">
        <div class="max-w-lg mx-auto lg:max-w-none bg-gray-50 lg:bg-transparent rounded-none lg:rounded-2xl shadow-none lg:shadow-sm pb-24 lg:pb-0">
            {{-- Header --}}
            <header class="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-gray-100/50 transition-all duration-300">
                ...
                <form action="{{ route('restaurants.index') }}" method="GET" class="px-4 pb-3">
                    <div class="relative">
                        ...
                        @if(request('search'))
                            <a href="{{ route('restaurants.index') }}" class="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-gray-400 hover:text-gray-600 rounded-full hover:bg-gray-100">
