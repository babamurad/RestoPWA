             ...
             x-data="{ 
                ...
                async init() {
                    ...
                    window.addEventListener('submit-order-failed', (e) => {
                        ...
                        if (e.detail?.reason === 'multi_vendor') {
                            Swal.fire({
                                title: 'Смешанная корзина',
                                text: 'В корзине товары из разных ресторанов. Пожалуйста, очистите корзину или оставьте товары только одного заведения.',
                                icon: 'warning',
