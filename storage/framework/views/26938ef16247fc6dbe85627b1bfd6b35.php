...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> RestoPWA - Доставка еды <?php $__env->endSlot(); ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!request()->is('*/desktop*')): ?>
...
<?php endif; ?>
    ...
    <main x-data="{ activeCategory: null, searchQuery: '' }" @global-search.window="searchQuery = $event.detail" class="max-w-lg mx-auto md:max-w-4xl lg:max-w-6xl xl:max-w-7xl px-4 py-6 space-y-8 lg:py-10 pb-24 lg:pb-12">
            ...
            >
                ...
                >
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <button
                            @click="activeCategory = activeCategory === '<?php echo e($category->name); ?>' ? null : '<?php echo e($category->name); ?>'"
                            :class="activeCategory === '<?php echo e($category->name); ?>'
                                ? 'bg-orange-500 text-white shadow-lg shadow-orange-200 ring-2 ring-orange-500 ring-offset-2'
                                : 'bg-white text-gray-700 border border-gray-100 hover:border-orange-500 hover:shadow-md'"
                            class="flex-none w-20 md:w-28 flex flex-col items-center gap-2 p-3 md:p-4 rounded-2xl transition-all touch-feedback group snap-start"
                        >
                            <div :class="activeCategory === '<?php echo e($category->name); ?>' ? 'bg-white/20' : 'bg-gray-50 group-hover:bg-orange-50'" 
                                 class="w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center transition-colors">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category->icon): ?>
                                    <span class="text-xl md:text-2xl"><?php echo e($category->icon); ?></span>
                                <?php else: ?>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 13.87A4 4 0 0 1 7.41 6a5.11 5.11 0 0 1 1.05-1.54 5 5 0 0 1 7.08 0A5.11 5.11 0 0 1 16.59 6 4 4 0 0 1 18 13.87V21H6Z"/><line x1="6" y1="17" x2="18" y2="17"/></svg>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <span class="text-[9px] md:text-xs font-bold whitespace-nowrap uppercase tracking-wider text-ellipsis overflow-hidden w-full text-center"><?php echo e($category->name); ?></span>
                        </button>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($popularRestaurants->count()): ?>
            <section x-show="!searchQuery">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-bold text-gray-900 font-inter">Популярные сейчас</h2>
                    <a href="<?php echo e(route('restaurants.index')); ?>" class="text-sm text-orange-500 font-bold hover:text-orange-600 transition-colors flex items-center gap-1">
                        Все
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                    </a>
                </div>
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $popularRestaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restaurant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a href="<?php echo e(route('restaurants.show', $restaurant->slug)); ?>"
                           x-show="!activeCategory || <?php echo e(json_encode($restaurant->categories->pluck('name')->toArray())); ?>.includes(activeCategory)"
                           ...
                           class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden card-hover touch-feedback group">
                            <div class="relative h-32 md:h-40 overflow-hidden">
                                <img src="<?php echo e($restaurant->image_url); ?>"
                                ...
                                <div class="absolute top-3 right-3 bg-white/95 backdrop-blur-sm px-2 py-1 rounded-lg shadow-sm border border-gray-50">
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="font-bold text-gray-900 text-[10px]"><?php echo e($restaurant->rating); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="p-4">
                                <h3 class="font-bold text-gray-900 text-sm md:text-base truncate group-hover:text-orange-500 transition-colors"><?php echo e($restaurant->name); ?></h3>
                                <div class="flex items-center gap-3 mt-2 text-[11px] md:text-xs text-gray-400 font-medium font-inter">
                                    <span class="flex items-center gap-1">
                                        ...
                                        <?php echo e($restaurant->delivery_time); ?> мин
                                    </span>
                                    <span class="flex items-center gap-1">
                                        ...
                                        <?php echo e($restaurant->delivery_fee == 0 ? 'Бесплатно' : $restaurant->delivery_fee . ' ₽'); ?>
        ...
        <section>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurants->count()): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $restaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restaurant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                        ...
                        ?>
                        <div x-show="(!activeCategory || <?php echo e(json_encode($restaurant->categories->pluck('name')->toArray())); ?>.includes(activeCategory)) && (!searchQuery || '<?php echo e($searchableText); ?>'.includes(searchQuery))"
                             x-transition:enter="transition ease-out duration-300"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bottom-nav','data' => ['active' => 'home']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\OSPanel\domains\RestoPWA\resources\views/home.blade.php ENDPATH**/ ?>