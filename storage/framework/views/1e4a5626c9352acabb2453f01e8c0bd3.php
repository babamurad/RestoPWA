...
<header class="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm">
    <div class="max-w-lg mx-auto md:max-w-4xl lg:max-w-6xl xl:max-w-7xl flex items-center gap-2 sm:gap-3 px-3 sm:px-4 h-14 md:h-16">
        ...
        <?php if (! $__env->hasRenderedOnce('d9e7610b-5703-4744-9aff-d6e51f222eb1')): $__env->markAsRenderedOnce('d9e7610b-5703-4744-9aff-d6e51f222eb1'); ?>
        <script>
...
</div><?php /**PATH C:\OSPanel\home\RestoPWA\resources\views/components/header.blade.php ENDPATH**/ ?>